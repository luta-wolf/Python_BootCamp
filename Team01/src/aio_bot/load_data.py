...
def dict_to_json_player(data: str):
    """
...
def dict_to_json_enemy(data: str):
    """
...
def dict_to_json_location(data: str):
    """
...
def dict_to_json_question(data: str):
    """
